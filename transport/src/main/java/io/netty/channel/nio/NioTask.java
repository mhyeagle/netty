...
/**
 * An arbitrary task that can be executed by {@link EpollEventLoop} when a {@link SelectableChannel} becomes ready.
 *
 * @see EpollEventLoop#register(SelectableChannel, int, NioTask)
 */
