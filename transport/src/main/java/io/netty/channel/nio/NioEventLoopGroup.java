...
public class EpollEventLoopGroup extends MultithreadEventLoopGroup {
    ...
    public EpollEventLoopGroup(int nThreads, Executor executor, final SelectorProvider selectorProvider,
    ...
    public void rebuildSelectors() {
        for (EventExecutor e: this) {
            ((EpollEventLoop) e).rebuildSelector();
        }
    }
    ...
    protected EventLoop newChild(Executor executor, Object... args) throws Exception {
        ...
        return new EpollEventLoop(this, executor, (SelectorProvider) args[0],
