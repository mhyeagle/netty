...
public final class SctpTestPermutation {
    ...
    private static final EventLoopGroup nioBossGroup =
            new EpollEventLoopGroup(BOSSES, new DefaultThreadFactory("testsuite-sctp-nio-boss", true));
    private static final EventLoopGroup nioWorkerGroup =
            new EpollEventLoopGroup(WORKERS, new DefaultThreadFactory("testsuite-sctp-nio-worker", true));
